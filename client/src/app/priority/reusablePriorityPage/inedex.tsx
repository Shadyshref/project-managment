...
import TackCrad from "@/components/TaskCard";
      ...
      <Header
        ...
        buttonComponent={
          <button
            ...
            className="mr-3 bg-blue-500 rounded px-4 py-2 hover:bg-blue-700 text-white font-bold "
          >
            Add Task
          </button>
        }
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredTasks?.map((task: Task) => (
            <TackCrad key={task.id} task={task} />
          ))}
        </div>
      ) : (
        view === "table" &&
